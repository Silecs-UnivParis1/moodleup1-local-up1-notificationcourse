...
function local_up1_notificationcourse_extend_navigation_course() {
    global $OUTPUT, $PAGE;
    ...
    $linkItem = '<a class="dropdown-item editing_notifications menu-action cm-edit-action" data-action="notifications" role="menuitem" href="'
        . htmlspecialchars(new moodle_url('/local/up1_notificationcourse/notificationcourse.php', ['id' => '123XYZ321']))
